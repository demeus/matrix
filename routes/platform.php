...
Route::screen('prices', PriceListScreen::class)
    ...
    ->breadcrumbs(function (Trail $trail) {
        return $trail
            ->parent('platform.index')
            ->push(__('prices.index'), route('platform.prices'));
    });
...
Route::screen('services/{service}/edit', ServiceEditScreen::class)
    ...
    ->breadcrumbs(function (Trail $trail, \App\Models\Service $service) {
        return $trail
            ->parent('platform.services')
            ->push(__('crud.edit'), route('platform.services.edit', $service));
    });
...
Route::screen('services/create', ServiceEditScreen::class)
    ...
    ->breadcrumbs(function (Trail $trail) {
        return $trail
            ->parent('platform.services')
            ->push(__("crud.add_a_new"), route('platform.services.create'));
    });
...
Route::screen('services', ServiceListScreen::class)
    ...
    ->breadcrumbs(function (Trail $trail) {
        return $trail
            ->parent('platform.index')
            ->push(__('services.index'), route('platform.services'));
    });
